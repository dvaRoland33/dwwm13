...
function rempliSelect(zone,mini,maxi,interval)
...
function visibilitePrix(){
    rempliSelect('prixMini',0,100,25)
    rempliSelect('prixMaxi',0,100,25)
    visibiliteOptions('Prix')
}
/* on gére l'affichage des notes */
function visibiliteNotes(){
    rempliSelect('noteMini',0,5,1)
    rempliSelect('noteMaxi',0,5,1)
